...
define config.save_directory = "down-1728971238"
...
# define config.window = False  # False для полноэкранного режима, True для оконного режима
# define gui.text_size = 20
# define gui.window_height = 1  # Высота окна диалога
# define gui.window_padding = 3  # Внутренние отступы
